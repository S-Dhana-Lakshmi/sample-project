//function loadjson(file,callback){
	...
	//xhr.send(null);
//}
//loadjson("myfirst.json",function(text){
...
function basics(det){
	...
	email.href="mailto:sunkaridhanalakshmi2913@gmail.com";
	email.textContent="sunkaridhanalakshmi2913@gmail.com";
	ch.appendChild(email);
	var number=document.createElement("h3");
	number.textContent="9393212676";
